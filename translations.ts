...
export const translations: LanguagePack = {
    ar: {
        ...
        set_credits: 'تحديد رصيد الانتقال بالدين',
        set_credits_desc: 'يرجى تحديد الحد الأدنى للرصيد السنوي المطلوب للانتقال إلى السنة الموالية، حسب متطلبات كليتك.',
        set_credits_option_30: 'الانتقال بـ 30 رصيدًا كحد أدنى',
        set_credits_option_45: 'الانتقال بـ 45 رصيدًا كحد أدنى',
        theme: 'المظهر',
        light_theme: 'الفاتح',
        dark_theme: 'الداكن',
        theme_auto: 'تلقائي',
    ...
    en: {
        ...
        set_credits_desc: 'Please set the minimum annual credits required for promotion to the next year, based on your faculty\'s requirements.',
        set_credits_option_30: 'Minimum 30 credits for promotion',
        set_credits_option_45: 'Minimum 45 credits for promotion',
        theme: 'Theme',
        light_theme: 'Light',
        dark_theme: 'Dark',
    ...
    fr: {
        ...
        set_credits_desc: 'Veuillez définir le nombre minimum de crédits annuels requis pour la promotion, conformément aux règles de votre faculté.',
        set_credits_option_30: 'Minimum 30 crédits pour la promotion',
        set_credits_option_45: 'Minimum 45 crédits pour la promotion',
        theme: 'Thème',
        light_theme: 'Clair',
        dark_theme: 'Sombre',
